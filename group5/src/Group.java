 ...
 * In this case, the class group comprises another class EnumerateStudents (internal class),
 * which in turn implements Iterator interface.
 * In other words, the class Group has an array which implements an iterator as internal
 * class.
 */
...
public class Group {
	...
	public class EnumerateStudents implements Iterator<Student> {
		Student [] students;
		int numStudents;
		int iter;				// Current position of the Iterator
		
		public EnumerateStudents (Student [] students, int numStudents) {
	...
	public Iterator<Student> students () {
		return new EnumerateStudents(students, numStudents);
	}
